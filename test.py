...
from classes.modelLayer.convolution2d import Conv2d
from classes.modelLayer.dense import Dense
from classes.modelLayer.flatten import Flatten
from classes.modelLayer.maxpooling import Maxpooling
